...
public class UserDaoimpl implements IUserDao{
    ...
    public UserModel findByUserName(String userName) {
        ...
        try{
            Connection con = new DBConnectMySQL().getDatabaseConnection();
    ...
    public List<UserModel> findAll() {
        ...
        try {
            con = new DBConnectMySQL().getDatabaseConnection();
            ps = con.prepareStatement(sql);
            rs = ps.executeQuery();
            while (rs.next()) {
                UserModel user = new UserModel();
    ...
    public UserModel findByUsernameAndEmail(String username, String email) {
        ...
        try {
            con = new DBConnectMySQL().getDatabaseConnection(); // Tạo kết nối
